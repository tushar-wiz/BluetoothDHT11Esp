...
#define TEST_DEVICE_NAME            "ESP_GATTS_TEMP"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[2] = (hum) & 0xff;
        rsp.attr_value.value[3] = (hum<<8) & 0xff;
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        for(int i=15;i>=0;i--){
            gl_profile_tab.char_uuid.uuid.uuid128[i] = gatts_char_uuid128[i];
        }
